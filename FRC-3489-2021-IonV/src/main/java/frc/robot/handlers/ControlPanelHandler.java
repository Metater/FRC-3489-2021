...
import frc.robot.types.ControlPanelStageType;
...
public class ControlPanelHandler extends BaseHandler implements IRobotListener, ITeleopListener, IButtonListener {
    ...
    public ControlPanelHandler(RobotHandler robotHandler)
    {
        ...
        RawButtonUpdate liftCPSpinner = new RawButtonUpdate(this, PeriodicType.Teleop, "LiftCPSpinner", new ButtonLocation(Constants.Button.LiftCPSpinner, JoystickType.Manipulator));
        ...
        buttonUpdateListenerHandler.addButtonUpdate(liftCPSpinner);
    ...
    {
        if (buttonUpdate.buttonUpdateName == "LiftCPSpinner")
        {
        ...
        else if (buttonUpdate.buttonUpdateName == "SpinCPSpinner")
        {
            if (buttonUpdate.buttonUpdateEventType == ButtonUpdateEventType.On)
            {
                if (stage == ControlPanelStageType.Stage1)
