...
public class ColorSpinnerHandler extends BaseHandler {
    ...
    public void teleopPeriodic()
    {
        ...
        //robotHandler.shuffleboardHandler.displayDouble("Red", detectedColor.red);
        //robotHandler.shuffleboardHandler.displayDouble("Green", detectedColor.green);
        //robotHandler.shuffleboardHandler.displayDouble("Blue", detectedColor.blue);
        //robotHandler.shuffleboardHandler.displayDouble("Confidence", match.confidence);
        //robotHandler.shuffleboardHandler.displayString("Detected Color", colorString);
        //robotHandler.shuffleboardHandler.displayDouble("Red-yellow passes", redYellowPasses);
        //robotHandler.shuffleboardHandler.displayDouble("Spinner current", colorSpinner.getStatorCurrent());
        //robotHandler.shuffleboardHandler.displayString("Stage", stage.toString());
        //robotHandler.shuffleboardHandler.displayString("Game Data", DriverStation.getInstance().getGameSpecificMessage());
    ...
    private void trySpinAndLiftColor()
    {
        ...
        if (robotHandler.inputHandler.shouldSpinColorSpinner())
        {
          ...
          else if (stage == ControlPanelStage.Stage2)
          {
            ...
            robotHandler.shuffleboardHandler.displayString("Color to find", String.valueOf(colorToFind));
            char shiftedColor = getShiftedColor(gameData);
            robotHandler.shuffleboardHandler.displayString("Shifted color", String.valueOf(shiftedColor));
